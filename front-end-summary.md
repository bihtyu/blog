...
## CSS盒模型
![image](https://img.mukewang.com/szimg/5a2632520001161419201080.jpg)
...
Event对象的常见应用  
1、event.preventDefault()：阻止默认事件，例如a标签跳转；  
...
2、过滤：（1）移除用户上传的dom属性，如onerror等。（2）移除用户上传的style节点、script节点、iframe节点。  
